...
void setup() {
  Serial.begin(115000);
  IPAddress  ip(192,168,10,46);      // <‑‑ choose the address you want
  IPAddress  gw(192,168,10,1);       // gateway / router
  IPAddress  nm(255,255,255,0);      // subnet mask
...
// Assign mappings
  mapping.push_back({1, IPAddress(192,168,10,1), 1});
